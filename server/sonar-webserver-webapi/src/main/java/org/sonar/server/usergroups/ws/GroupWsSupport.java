...
public class GroupWsSupport {
  ...
  public GroupDto findGroupDto(DbSession dbSession, Request request) {
    ...
    return findGroupDto(dbSession, organizationKey, groupName);
  }

  public GroupDto findGroupDto(DbSession dbSession, String organizationKey, String groupName) {

    OrganizationDto org = findOrganizationByKey(dbSession, organizationKey);
  ...
  public GroupUuidOrAnyone findGroupOrAnyone(DbSession dbSession, String organizationKey, String groupName) {
  ...
  private GroupDto updateName(DbSession dbSession, GroupDto group, @Nullable String newName) {
    if (newName != null && !newName.equals(group.getName())) {
      ...
      checkNameDoesNotExist(dbSession, newName, group.getOrganizationUuid());
  ...
  void checkNameDoesNotExist(DbSession dbSession, String name, String organizationUuid) {
