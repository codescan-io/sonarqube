...
public class SearchMembersAction implements OrganizationsWsAction {
  ...
  private SearchMembersWsResponse buildResponse(List<UserDto> users, Paging paging, @Nullable Multiset<String> groupCountByLogin) {
    ...
    response.setPaging(buildWsPaging(paging));
  ...
  private static Common.Paging buildWsPaging(Paging paging) {
