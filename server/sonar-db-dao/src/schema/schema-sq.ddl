...
CREATE UNIQUE NULLS DISTINCT INDEX "UNIQ_GROUP_ROLES" ON "GROUP_ROLES"("ORGANIZATION_UUID" NULLS FIRST, "GROUP_UUID" NULLS FIRST, "COMPONENT_UUID" NULLS FIRST, "ROLE" NULLS FIRST);
...
CREATE UNIQUE NULLS DISTINCT INDEX "UNIQ_GROUPS_NAME" ON "GROUPS"("ORGANIZATION_UUID" NULLS FIRST, "NAME" NULLS FIRST);
...
CREATE UNIQUE NULLS DISTINCT INDEX "UNIQ_ORG_QUALITY_GATES" ON "ORG_QUALITY_GATES"("ORGANIZATION_UUID" NULLS FIRST, "QUALITY_GATE_UUID" NULLS FIRST);
...
CREATE UNIQUE NULLS DISTINCT INDEX "ORGANIZATION_KEY" ON "ORGANIZATIONS"("KEE" NULLS FIRST);
