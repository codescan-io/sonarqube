...
public class UserPermissionDaoTest {
  ...
  public void deleteProjectPermissionOfAnyUser_deletes_specified_permission_for_any_user_on_the_specified_component() {
    ...
    assertThat(underTest.selectGlobalPermissionsOfUser(dbSession, user1.getUuid(), null)).containsOnly(GlobalPermission.SCAN.getKey());
    assertThat(underTest.selectGlobalPermissionsOfUser(dbSession, user2.getUuid(), null)).containsOnly(GlobalPermission.SCAN.getKey());
