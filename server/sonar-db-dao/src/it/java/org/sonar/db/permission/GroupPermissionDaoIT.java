...
public class GroupPermissionDaoIT {
  ...
  public void selectByGroupUuids_on_global_permissions() {
    ...
    assertThat(underTest.selectByGroupUuids(dbSession, null, List.of(group1.getUuid()), null))
    ...
    assertThat(underTest.selectByGroupUuids(dbSession, null, List.of(group2.getUuid()), null)).isEmpty();

    assertThat(underTest.selectByGroupUuids(dbSession, null, List.of(group3.getUuid()), null))
      .extracting(GroupPermissionDto::getGroupUuid, GroupPermissionDto::getRole, GroupPermissionDto::getComponentUuid)
      .containsOnly(tuple(group3.getUuid(), GlobalPermission.ADMINISTER.getKey(), null));

    assertThat(underTest.selectByGroupUuids(dbSession, null, List.of(ANYONE_UUID), null))
      .extracting(GroupPermissionDto::getGroupUuid, GroupPermissionDto::getRole, GroupPermissionDto::getComponentUuid)
      .containsOnly(
        tuple(ANYONE_UUID, GlobalPermission.SCAN.getKey(), null),
        tuple(ANYONE_UUID, GlobalPermission.PROVISION_PROJECTS.getKey(), null));

    assertThat(underTest.selectByGroupUuids(dbSession, null, List.of(group1.getUuid(), group2.getUuid(), ANYONE_UUID), null)).hasSize(3);
    assertThat(underTest.selectByGroupUuids(dbSession, null, List.of(MISSING_UUID), null)).isEmpty();
