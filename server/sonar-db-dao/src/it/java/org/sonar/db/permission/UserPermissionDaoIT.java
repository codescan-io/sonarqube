...
public class UserPermissionDaoIT {
  ...
  public void deleteProjectPermissionOfAnyUser_has_no_effect_if_specified_entity_does_not_exist() {
    ...
    assertThat(underTest.selectGlobalPermissionsOfUser(dbSession, user.getUuid(), null)).containsOnly(GlobalPermission.SCAN.getKey());
  }
  ...
  public void deleteProjectPermissionOfAnyUser_has_no_effect_if_specified_component_does_not_have_specified_permission() {
    ...
    assertThat(deletedCount).isZero();
    assertThat(underTest.selectGlobalPermissionsOfUser(dbSession, null, user.getUuid())).containsOnly(GlobalPermission.SCAN.getKey());
  ...
  public void deleteProjectPermissionOfAnyUser_deletes_specified_permission_for_any_user_on_the_specified_component() {
    ...
    assertThat(underTest.selectGlobalPermissionsOfUser(dbSession, null, user1.getUuid())).containsOnly(GlobalPermission.SCAN.getKey());
    assertThat(underTest.selectGlobalPermissionsOfUser(dbSession, null, user2.getUuid())).containsOnly(GlobalPermission.SCAN.getKey());
