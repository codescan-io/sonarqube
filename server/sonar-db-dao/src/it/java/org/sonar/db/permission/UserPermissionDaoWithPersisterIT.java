...
public class UserPermissionDaoWithPersisterIT {
  ...
  public void userGlobalPermissionInsertAndDeleteArePersisted() {
    ...
    UserPermissionDto dto = new UserPermissionDto(Uuids.create(), null, ADMINISTER.getKey(), user.getUuid(), null);
    ...
    underTest.deleteGlobalPermission(dbSession, user, ADMINISTER.getKey(), null);
  ...
  public void userPortfolioPermissionIsPersisted() {
    ...
    UserPermissionDto dto = new UserPermissionDto(Uuids.create(), null, ADMINISTER.getKey(), user.getUuid(), portfolio.uuid());
  ...
  public void deleteUserPermissionOfAnyUserIsPersisted() {
    ...
    UserPermissionDto dto = new UserPermissionDto(Uuids.create(), null, SCAN.getKey(), user.getUuid(), project.getUuid());
    underTest.insert(dbSession, dto, project, user, null);
