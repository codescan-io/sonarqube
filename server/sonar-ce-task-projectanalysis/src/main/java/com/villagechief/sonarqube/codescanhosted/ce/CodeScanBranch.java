...
class CodeScanBranch implements Branch {
    ...
    CodeScanBranch(final String branchName, @Nullable final String targetBranchUuid, final BranchType branchType,
    ...
    public String toString() {
        return "CodeScanBranch{branchName=" + branchName + ", targetBranchUuid=" + targetBranchUuid + ",branchType="
