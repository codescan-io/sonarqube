  ...
  return (
    <PageContentFontWrapper className="sw-typo-lg sw-p-6 sw-h-screen">
      ...
      >
        ...
        <TableRow>
          <ContentCell>
            [AutoRABIT CodeScan Home Page](https://knowledgebase.autorabit.com/codescan/en)
          </ContentCell>
          <ContentCell>
            <HtmlFormatter>
              <a href="https://knowledgebase.autorabit.com/codescan/en">AutoRABIT CodeScan Home Page</a>
            </HtmlFormatter>
          </ContentCell>
        </TableRow>
        <TableRow>
