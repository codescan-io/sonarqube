        ...
        return (
          <MsaGate
            ...
            <div className="landing">
                <div className="home">
                    <img className="light-emblem" src='/images/autorabit-icon-logo.svg' alt="" style={{ width: '3.25rem', height: '3.25rem' }} />
                    <h1 style={{ paddingTop: '2rem', paddingBottom: '2rem' }}>Welcome to AutoRABIT CodeScan</h1>
                    {
