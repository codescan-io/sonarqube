...
<head>
    ...
    <!-- Google Tag Manager -->
    <script>
      if (%GA_DISABLE% == false && (window.location.hostname.includes('codescan.io'))) {
    ...
    <!-- Pendo.io -->
    <script>
      if (%PENDO_DISABLE% == false && (window.location.hostname.includes('codescan.io') || window.location.hostname.includes('autorabit.com'))) {
