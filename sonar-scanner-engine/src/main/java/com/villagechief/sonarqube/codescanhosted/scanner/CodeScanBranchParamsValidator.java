...
public class CodeScanBranchParamsValidator  implements BranchParamsValidator
{
	...
	@Override
	public void validate(final List<String> validationMessages, @Nullable final String deprecatedBranchName) {
	    ...
	    if (StringUtils.isNotEmpty(branchName) && !isValid(branchName) ) {
	        validationMessages.add(String.format("Invalid branch name: \"%s\". Needs to be a valid git branch name", new Object[] { branchName }));
	    }
	}
